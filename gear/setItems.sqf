...
_scope1 = if (isNil "lt_template_scope1") then {"CUP_optic_CompM4"} else {lt_template_scope2};  	// Fuck you Willem
...
// Default setup
_attachments = if (isNil "lt_template_attachments") then {[_attach1,_scope1]} else {lt_template_attachments}; // The default attachment set for most units, overwritten in the individual unitType
