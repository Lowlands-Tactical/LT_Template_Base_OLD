// filename 	"CSAT2035.sqf"
// loadout name "CSAT 2035"
...
lt_template_rifle          	 = 	 "arifle_CTAR_blk_F";
lt_template_riflemag       	 = 	 "30Rnd_580x42_Mag_F";
lt_template_riflemag_t     	 = 	 "30Rnd_580x42_Mag_Tracer_F";

//Medic, Rifleman At
lt_template_carbine        	 = 	 "arifle_CTAR_blk_F";
lt_template_carbinemag     	 = 	 "30Rnd_580x42_Mag_F";
lt_template_carbinemag_tr          	 = 	 "30Rnd_580x42_Mag_Tracer_F";
...
lt_template_glrifle        	 = 	 "arifle_CTAR_GL_blk_F";
lt_template_glriflemag     	 = 	 "30Rnd_580x42_Mag_F";
lt_template_glriflemag_tr          	 = 	 "30Rnd_580x42_Mag_Tracer_F";
...
// Automatic Rifleman
lt_template_AR     	 = 	 "arifle_CTARS_blk_F";
lt_template_ARmag          	 = 	 "100Rnd_580x42_Mag_F";
lt_template_ARmag_tr       	 = 	 "100Rnd_580x42_Mag_Tracer_F";

// Medium MG Gunner
lt_template_MMG    	 = 	 "arifle_CTARS_hex_F";
lt_template_MMGmag         	 = 	 "100Rnd_580x42_Mag_F";
lt_template_MMGmag_tr      	 = 	 "100Rnd_580x42_Mag_Tracer_F";

// Designated Marksman
lt_template_DMrifle        	 = 	 "srifle_DMR_07_blk_F";
lt_template_DMriflemag     	 = 	 "20Rnd_650x39_Cased_Mag_F";
...
// Static weapons
lt_template_baghmgg        	 = 	 "O_HMG_01_high_weapon_F";
lt_template_baghmgag       	 = 	 "O_HMG_01_support_high_F";

lt_template_baghatg        	 = 	 "O_AT_01_weapon_F";
lt_template_baghatag       	 = 	 "O_HMG_01_support_F";

lt_template_bagmtrg        	 = 	 "O_Mortar_01_weapon_F";
lt_template_bagmtrag       	 = 	 "O_Mortar_01_support_F";
