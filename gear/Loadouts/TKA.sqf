...
lt_template_scope2         	 = 	 "CUP_optic_PSO_1"; // scope sniper
lt_template_scope3         	 = 	 "CUP_optic_PSO_1";
...
lt_template_rifle          	 = 	 "CUP_arifle_FNFAL_railed";
lt_template_riflemag       	 = 	 "CUP_20Rnd_762x51_FNFAL_M";
lt_template_riflemag_t     	 = 	 "CUP_20Rnd_762x51_FNFAL_M";
		
//Medic, Rifleman At		
lt_template_carbine        	 = 	 "CUP_arifle_FNFAL_railed";
lt_template_carbinemag     	 = 	 "CUP_20Rnd_762x51_FNFAL_M";
lt_template_carbinemag_tr          	 = 	 "CUP_20Rnd_762x51_FNFAL_M";
		
// Pilots, Vehicle crew, Submachinegunner		
lt_template_smg    	 = 	 "CUP_arifle_AKS74U";
lt_template_smgmag         	 = 	 "CUP_30Rnd_545x39_AK_M";
lt_template_smgmag_tr      	 = 	 "CUP_30Rnd_TE1_Green_Tracer_545x39_AK_M";
		
		
// Commander, Squadleader, Fireteam leader, Spotter, Grenadier		
lt_template_glrifle        	 = 	 "CUP_arifle_AK74M_GL";
...
// Automatic Rifleman		
lt_template_AR     	 = 	 "CUP_arifle_RPK74M";
...
// Sniper		
lt_template_SNrifle        	 = 	 "CUP_srifle_SVD";
