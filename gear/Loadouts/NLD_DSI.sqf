...
lt_template_rifle = "CUP_arifle_HK416_CQB_Black";
lt_template_riflemag   = "CUP_30Rnd_556x45_PMAG_QP";
lt_template_riflemag_t = "CUP_30Rnd_556x45_PMAG_QP_Tracer_Green";

//Medic, Vehicle crew, Rifleman At
lt_template_carbine = "CUP_arifle_HK416_CQB_Black";
lt_template_carbinemag    = lt_template_riflemag;
lt_template_carbinemag_tr = lt_template_riflemag_t;

// Pilots, Submachinegunner
lt_template_smg = "SMG_03C_black";
lt_template_smgmag    = "CUP_50Rnd_570x28_Green_Tracer_P90_M";
lt_template_smgmag_tr = "CUP_50Rnd_570x28_Green_Tracer_P90_M";

// Commander, Squadleader, Fireteam leader, Spotter, Grenadier
lt_template_glrifle = "CUP_arifle_HK416_CQB_AG36";
lt_template_glriflemag    = "CUP_30Rnd_556x45_PMAG_QP";
lt_template_glriflemag_tr = "CUP_30Rnd_556x45_PMAG_QP_Tracer_Green";
...
// Medium MG Gunner
lt_template_MMG = "CUP_lmg_FNMAG_RIS_modern";
lt_template_MMGmag    = "150Rnd_762x51_Box_Tracer";
lt_template_MMGmag_tr = "150Rnd_762x51_Box_Tracer";
...
// Sniper
lt_template_SNrifle = "srifle_DMR_02_F";
lt_template_SNrifleMag = "10Rnd_338_Mag";
