...
lt_template_scopeDM          = 	 "CUP_optic_SB_11_4x20_PM"; // DM Scope
...
// Automatic Rifleman
lt_template_AR     	 = 	 "CUP_arifle_MG36";
...
lt_template_DMriflemag     	 = 	 "CUP_20Rnd_762x51_HK417";
...
// Sniper
lt_template_SNrifle             =      "CUP_srifle_G22_blk";
