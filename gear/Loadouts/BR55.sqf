...
lt_template_scope1         	 = 	 "OPTRE_BR55HB_Scope"; // normal scope
lt_template_scope2         	 = 	 "OPTRE_BR55HB_Scope"; // DM Scope
lt_template_scope3         	 = 	 "OPTRE_SRS99_Scope"; // Sniper Scope
...
lt_template_rifle          	 = 	 "OPTRE_BR55HB";
lt_template_riflemag       	 = 	 "OPTRE_36Rnd_95x40_Mag";
lt_template_riflemag_t     	 = 	 "OPTRE_36Rnd_95x40_Mag_Tracer";

//Medic, Rifleman At
lt_template_carbine        	 = 	 "OPTRE_BR55";
lt_template_carbinemag     	 = 	 "OPTRE_36Rnd_95x40_Mag";
lt_template_carbinemag_tr    = 	 "OPTRE_36Rnd_95x40_Mag_Tracer";

// Pilots, Vehicle crew, Submachinegunner
lt_template_smg    	         = 	 "OPTRE_BR55";
lt_template_smgmag         	 = 	 "OPTRE_36Rnd_95x40_Mag";
lt_template_smgmag_tr      	 = 	 "OPTRE_36Rnd_95x40_Mag_Tracer";

// Commander, Squadleader, Fireteam leader, Spotter, Grenadier
lt_template_glrifle        	 = 	 "OPTRE_HMG38";
lt_template_glriflemag     	 = 	 "OPTRE_40Rnd_30x06_Mag";
lt_template_glriflemag_tr    = 	 "OPTRE_40Rnd_30x06_Mag_Tracer";
...
lt_template_pistol         	 = 	 "OPTRE_M6G";
lt_template_pistolmag      	 = 	 "OPTRE_8Rnd_127x40_Mag_Tracer";
...
// Sniper
lt_template_SNrifle          =   "OPTRE_SRS99D";
