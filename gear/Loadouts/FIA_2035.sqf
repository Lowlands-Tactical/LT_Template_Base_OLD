// filename 	"FIA2035.sqf"
// loadout name "FIA 2035"
...
lt_template_scope2         	 = 	 "optic_KHS_old"; // scope sniper
lt_template_scope3         	 = 	 "";
...
lt_template_rifle          	 = 	 "arifle_TRG21_F";
lt_template_riflemag       	 = 	 "30Rnd_556x45_Stanag";
lt_template_riflemag_t     	 = 	 "30Rnd_556x45_Stanag_Tracer_Yellow";

//Medic, Rifleman At
lt_template_carbine        	 = 	 "arifle_TRG21_F";
lt_template_carbinemag     	 = 	 "30Rnd_556x45_Stanag";
lt_template_carbinemag_tr          	 = 	 "30Rnd_556x45_Stanag_Tracer_Yellow";

// Pilots, Vehicle crew, Submachinegunner
lt_template_smg    	 = 	 "hgun_PDW2000_F";
lt_template_smgmag         	 = 	 "30Rnd_9x21_Mag";
lt_template_smgmag_tr      	 = 	 "30Rnd_9x21_Yellow_Mag";

// Commander, Squadleader, Fireteam leader, Spotter, Grenadier
lt_template_glrifle        	 = 	 "arifle_TRG21_GL_F";
lt_template_glriflemag     	 = 	 "30Rnd_556x45_Stanag";
lt_template_glriflemag_tr          	 = 	 "30Rnd_556x45_Stanag_Tracer_Yellow";
...
lt_template_pistol         	 = 	 "hgun_Pistol_heavy_02_F";
lt_template_pistolmag      	 = 	 "6Rnd_45ACP_Cylinder";

// Automatic Rifleman
lt_template_AR     	 = 	 "LMG_Mk200_F";
lt_template_ARmag          	 = 	 "200Rnd_65x39_cased_Box";
lt_template_ARmag_tr       	 = 	 "200Rnd_65x39_cased_Box_Tracer";

// Medium MG Gunner
lt_template_MMG    	 = 	 "LMG_03_F";
lt_template_MMGmag         	 = 	 "200Rnd_556x45_Box_F";
lt_template_MMGmag_tr      	 = 	 "200Rnd_556x45_Box_F";

// Designated Marksman
lt_template_DMrifle        	 = 	 "srifle_DMR_06_camo_F";
lt_template_DMriflemag     	 = 	 "20Rnd_762x51_Mag";

// Rifleman AT
lt_template_RAT    	 = 	 "launch_B_Titan_short_tna_F";
...
// Sniper
lt_template_SNrifle             =      "CUP_srifle_CZ550";
lt_template_SNrifleMag          =      "CUP_5x_22_LR_17_HMR_M";
