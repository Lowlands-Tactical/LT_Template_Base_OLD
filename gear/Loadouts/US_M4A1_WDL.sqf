// filename 	"US M4A1 Woodland.sqf"
// loadout name "US M4A1 Woodland"

// Attachments Primary weapon	
lt_template_attach1        	 = 	 "CUP_acc_ANPEQ_2_camo";
lt_template_attach2        	 = 	 "CUP_acc_Flashlight_wdl";
lt_template_silencer1      	 = 	 "CUP_muzzle_snds_M16_camo";
lt_template_scope1         	 = 	 "CUP_optic_CompM2_Woodland2";
lt_template_scopeMG          	= 	 "CUP_optic_CompM2_Woodland2"; 
...
lt_template_smg    	 = 	 "CUP_arifle_M4A1_camo";
lt_template_smgmag     = 	 lt_template_riflemag;
lt_template_smgmag_tr  = 	 lt_template_riflemag_t;
		
// Commander, Squadleader, Fireteam leader, Spotter, Grenadier		
lt_template_glrifle        	 = 	 "CUP_arifle_M4A1_BUIS_camo_GL";
...
lt_template_glflarewhite        = 	 "CUP_1Rnd_StarFlare_White_M203";
lt_template_glflarered     	 = 	 "CUP_1Rnd_StarFlare_Red_M203";
lt_template_glflareyellow       = 	 "CUP_FlareYellow_M203";
lt_template_glflaregreen        = 	 "CUP_1Rnd_StarFlare_Green_M203";
...
// Medium MG Gunner		
lt_template_MMG    	 = 	 "CUP_lmg_Mk48_wdl";
...
// Designated Marksman		
lt_template_DMrifle    = 	 "CUP_srifle_M14_DMR";
lt_template_DMriflemag  = 	 "CUP_20Rnd_TE1_Green_Tracer_762x51_DMR";
...
lt_template_Mgrenade   = 	 "B_IR_Grenade";
