...
lt_template_attachSNP        = 	 "CUP_SVD_camo_g"; // Snip

lt_template_silencer1      	 = 	 "muzzle_snds_B_lush_F"; // rifles
lt_template_silencerSMG      	 = 	 "muzzle_snds_B_lush_F"; // MG
lt_template_silencerDM       = 	 ""; // DM
lt_template_silencerSNP      = 	 "CUP_muzzle_snds_KZRZP_SVD_woodland"; // Snip

lt_template_scope1         	 = 	 "optic_Holosight_lush_F"; // normal scope
lt_template_scopeSNP         = 	 "optic_DMS_weathered_Kir_F"; // DM
lt_template_scopeDM          = 	 "CUP_optic_PSO_1_1_open"; // Sniper
...
lt_template_rifle          	 = 	 "arifle_AK12_lush_F";
lt_template_riflemag       	 = 	 "30rnd_762x39_AK12_Lush_Mag_F";
lt_template_riflemag_t     	 = 	 "30rnd_762x39_AK12_Lush_Mag_Tracer_F";

//Medic, Rifleman At
lt_template_carbine        	 = 	 "arifle_AK12U_lush_F";
lt_template_carbinemag     	 = 	 "30rnd_762x39_AK12_Lush_Mag_F";
lt_template_carbinemag_tr    = 	 "30rnd_762x39_AK12_Lush_Mag_Tracer_F";
...
lt_template_glrifle        	 = 	 "arifle_AK12_GL_lush_F";
lt_template_glriflemag     	 = 	 "30rnd_762x39_AK12_Lush_Mag_F";
lt_template_glriflemag_tr    = 	 "30rnd_762x39_AK12_Lush_Mag_Tracer_F";
...
// Automatic Rifleman
lt_template_AR     	 = 	 "arifle_RPK12_lush_F";
lt_template_ARmag          	 = 	 "75rnd_762x39_AK12_Lush_Mag_F";
lt_template_ARmag_tr       	 = 	 "75rnd_762x39_AK12_Lush_Mag_Tracer_F";
...
// Sniper
lt_template_SNrifle             =      "CUP_srifle_SVD_wdl";
