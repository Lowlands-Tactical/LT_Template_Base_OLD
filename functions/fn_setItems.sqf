...
if (_activated) then {
		...
		lt_template_HMG = _logic getVariable ["lt_template_HMG", "LMG_Mk200_LP_BI_F"  ];
		lt_template_HMGmag = _logic getVariable ["lt_template_HMGmag", "200Rnd_65x39_cased_Box"  ];
		lt_template_HMGmag_tr = _logic getVariable ["lt_template_HMGmag_tr", "200Rnd_65x39_cased_Box_Tracer"  ];
