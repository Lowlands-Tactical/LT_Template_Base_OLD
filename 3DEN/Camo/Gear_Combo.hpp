	...
	class Controls: Controls
	{
		...
		class Value: ctrlCombo
		{
			...
			class Items
			{
				...
				{
					text = "US Airborne";
					data = "\lt_template_base\gear\Loadouts\US_airborne.sqf";
				};
				class LT_Gear_UK_Army
				{
					text = "UK Army";
					data = "\lt_template_base\gear\Loadouts\UK_Army.sqf";
				};
				class LT_Gear_USSR_Army
				{
					text = "USSR Army";
					data = "\lt_template_base\gear\Loadouts\USSR_Army.sqf";
				};
				class LT_Gear_GER_Army
				{
					text = "GER Army";
