/*  =====================================================================================================
 ...
 =====================================================================================================		
	Par�meters: [_artillery,(_rounds,_area,_cadence,_mincadence)] execvm "\lt_template_base\AI\UPSMON\UPSMON\MON_artillery_add.sqf";	
 ...
 =====================================================================================================
	...
	2. Exec module in int of static weapon
		...
		nul=[this] execVM "\lt_template_base\AI\UPSMON\UPSMON\MON_artillery_add.sqf";
