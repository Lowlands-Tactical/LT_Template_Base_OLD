...
if ( missionNamespace getVariable ["ace_common", false]) then {
	...
	_action = ["lt_main_enableGTP", "Enable Group Teleport", "", { lt_group_teleport = 1 }, { lt_group_teleport == 0 and serverCommandAvailable "#kick" } ] call ace_interact_menu_fnc_createAction;
	[player, 1, ["ACE_SelfActions", "lt_main"], _action] call ace_interact_menu_fnc_addActionToObject;

	_action = ["lt_main_disableGTP", "Disable Group Teleport", "", { lt_group_teleport = 0 }, { lt_group_teleport == 1 and serverCommandAvailable "#kick" } ] call ace_interact_menu_fnc_createAction;
	[player, 1, ["ACE_SelfActions", "lt_main"], _action] call ace_interact_menu_fnc_addActionToObject;
